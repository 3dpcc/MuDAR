...
pc_transformer = PCTransformer(lidar_cfg, None)
...
if __name__ == "__main__":
    ...
    for idx in range(0, 5):
        for seq in range(0, 12):
            point_paths = glob.glob(f"/zhu/data/Ford/train/{idx:02d}/{seq:02d}/**/*", recursive=True)
            ...
            to_save_path = f"/zhu/data/Ford/train/processed/{idx:02d}/{seq:02d}"
